...
export default function FAQ() {
  ...
  const FAQ_DATA = () => [
    ...
    {
      question: {
        en: "I am not sure if my English is good enough to apply to a school in the India. Can you help me with that?",
    ...
    },
    {
      ...
      answer: {
        ...
        tr: "Web sitemizdeki iletişim formunu kullanarak veya shivanshgupta6372@gmail.com adresine e-posta göndererek bizimle iletişime geçebilirsiniz.",
      },
    },
    {
      question: {
    ...
    },
    {
      ...
      answer: {
        en: "As a team that has resided in the India both as a student and a professional, we are ready to answer all your questions from academic life to daily life in the India.",
    ...
    {
      question: {
        en: "Is Helios Admissions based in the India?",
        tr: "Helios Admissions şirketi ABD merkezli mi?",
      },
      answer: {
        en: "Yes, Helios Admissions is based in the India. However, Helios Admissions is also registered in Delhi. Our team members reside in Bangalore and Gurgaon.",
    ...
    {
      question: {
        en: "My undergraduate GPA is below 2.5. Can I still apply to the universities in the India?",
    ...
    },
    {
      ...
      answer: {
        en: "Unfortunately, the majority of the universities in the India are not free. However, there are many scholarships and financial aid opportunities available for international students.",
    ...
    {
      question: {
        en: "Are there any full-ride scholarships available for international students in the India?",
    ...
    {
      question: {
        en: "Will I be able to work while I am studying in the India?",
