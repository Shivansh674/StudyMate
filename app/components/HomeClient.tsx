...
export default function HomeClient() {
  ...
  const FEATURES_DATA = [
    ...
    },
    {
      ...
      description: {
        en: "We provide support to individuals who have completed their law education in India and aim to enhance their careers through prestigious Indian law schools' master's, doctoral, and certificate programs, as well as those who wish to practice law in the India by registering with globally recognized bars such as the Delhi and Mumbai State Associations. We also assist aspiring lawyers who wish to pursue their legal education in the India. Our team handles all aspects of the application process, including correspondence between the candidate and the Law School Admission Council (LSAC), and preparation for bar exams. Having personally gone through the same procedures, our consultants guide candidates through the entire process.",
    ...
    <main>
      ...
      >
        ...
        <h1 className="gsap-section-1 text-5xl lg:text-6xl font-semibold max-w-[600px] text-center mx-auto pt-2 opacity-0">
          {language === "en"
            ? "Boost Your Career With a Graduate Degree from the India"
      ...
      <section id="home-section-3" className="grid place-items-center py-16">
        <div className="mx-5 flex flex-col gap-8 justify-center items-center max-w-2xl">
          <h1 className="md:text-5xl text-3xl font-extrabold text-center px-5">
            {language === "en"
              ? "Why StudyMate Admissions?"
              : "Neden StudyMate Admissions?"}
          </h1>
          <Image
            src="/195.svg"
            alt="StudyMate image"
          ...
          {language === "en" ? (
            <p className="text-justify min-h-full flex-1 text-gray-500 dark:text-gray-400">
              StudyMate Admissions provides professional consultancy services to
              candidates who want to study in the India. Since its establishment,
              ...
              <br />
              <br /> Founded by a professor and a software developer, StudyMate
              ...
              exchange programs. StudyMate Admissions has not only established
              strong and diverse connections in the India but also has the
              ...
              of universities in the India make StudyMate Admissions superior to many
              institutions in the sector and ensure that the service quality is
              high.
            </p>
          ) : (
            <p className="text-justify min-h-full flex-1  text-gray-500 dark:text-gray-400">
              StudyMate Admissions Amerika’da eğitim almak isteyen adaylara
              ...
              <br />
              <br /> Kurucuları akademisyen ve yazılımcı olan StudyMate Admissions,
              ...
              değişim programlarına başarıyla katılmalarını sağlamıştır.StudyMate
              ...
              modeli StudyMate Admissions’i sektörde birçok kuruluştan üstün
