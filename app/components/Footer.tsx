  ...
  return (
    ...
    >
      <div className="flex gap-16 dark:invert">
        ...
        <Link
          href="mailto:shivanshgupta6372@gmail.com"
          rel="noopener noreferrer"
          target="_blank"
          className="hover:cursor-pointer hover:scale-150 transition-all duration-300 active:scale-90"
        >
      ...
      <p>
        {language === "en"
          ? "Copyright © 2023 | All Rights Reserved | StudyMate Admissions"
          : "Copyright © 2023 | Tüm Hakları Saklıdır | StudyMate Admissions"}
      </p>
      <p>
        {language === "en"
          ? "Delhi, India"
