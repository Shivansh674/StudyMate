  ...
  return (
    ...
    >
      ...
      <div className="md:col-span-2">
        ...
        >
          {language === "en"
            ? "We offer two different service packages for students who want to study in the India. Which service package interests you?"
      ...
      <div className="md:col-span-2  ">
        ...
        >
          {language === "en"
            ? "What level of education are you interested in pursuing in the India?"
      ...
      <div className="md:col-span-2  ">
        ...
        >
          {language === "en"
            ? "Tell us why you want to study in the India and what you expect from the India education system."
        ...
        <textarea
          ...
          placeholder={
            language === "en"
              ? "The primary reason why I want to study in the India is that I want to have a global perspective. I want to study in a diverse environment and meet people from different cultures. It is very important for me to have a competitive education on a global level."
